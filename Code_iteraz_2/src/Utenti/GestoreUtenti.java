...
public interface GestoreUtenti {
    ...
    * Ogni tipo di Utente ha bisogno del suo Gestore specifico, dato che hanno campi differenti */
    ...
    /*In alternativa potremmo lasciare alla view la responsabilità di prende in input i dati, e creare l'oggetto.
    * ma dovremmo comunque fare un controllo della stringa per capire il tipo di utente che viene creato per inserirlo
